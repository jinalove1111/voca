...
// garden-stage-0..4)가 채워졌고, 2026-09-14에 9번째 키(book-shop)와
// 10번째 키(red-post-box)가 추가됐다(더 이상 빈 객체가 아님) — 소스
...
check(
  'src/assets/town/index.js — TOWN_ASSETS가 정확히 10개 드롭인 키를 포함',
...
check(
  'src/assets/town/index.js — TOWN_ASSETS에 나머지 13개 카탈로그 키는 여전히 없음(이모지 폴백 유지)',
