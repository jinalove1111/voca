...
const B = await addStudent('QA_DashKidB', CLASS, 'Unit 1')
...
check('결과 row에 표시용 name도 정확히 채워짐', rowA?.name === 'QA_DashKidA' && rowB?.name === 'QA_DashKidB')
...
const C = await addStudent('QA_DashKidC', CLASS, 'Unit 1')
