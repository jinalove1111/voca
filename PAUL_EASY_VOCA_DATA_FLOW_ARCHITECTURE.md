...
EASY_VOCA_SAAS_SECURITY_IMPLEMENTATION_CHECKLIST.md`, `PAUL_EASY_
VOCA_SAAS_ARCHITECTURE_PLAN.md`, `PAUL_EASY_VOCA_CUSTOMER_
OPERATION_PLAN.md`(§1~3 온보딩 프로세스 원본).
